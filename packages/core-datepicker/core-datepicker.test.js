...
describe('core-datepicker', () => {
  ...
  it('sets up properties', async () => {
    await browser.executeScript(function () {
      document.body.innerHTML = '<core-datepicker id="test" timestamp="'+new Date('2019-04-30T12:44:56Z').getTime()+'"></core-datepicker>'
    })
    ...
    await expect(browser.executeScript(function () { return document.querySelector('core-datepicker').days.join(',') })).toEqual('man,tirs,ons,tors,fre,lør,søn')
    await expect(browser.executeScript(function () { return document.querySelector('core-datepicker').months.join(',') }))
